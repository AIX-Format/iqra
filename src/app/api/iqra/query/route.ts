...
import { iqraThink, IQRABrainMode } from '../../../#core/brain'; // [TC] reason: relative path to canonical lib/iqra | id: c1-qbrain
import { IQRAMemory } from '../#memory/memory'; // [TC] reason: relative path to canonical lib/iqra | id: c1-qmem
